...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../TankGame_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is TankGame_soc
SOPC_NAME := TankGame_soc
...
# The SOPC System ID 
# setting SOPC_SYSID is 4207599310
SOPC_SYSID_FLAG += --id=4207599310
ELF_PATCH_FLAG  += --id 4207599310
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1491794758
SOPC_SYSID_FLAG += --timestamp=1491794758
ELF_PATCH_FLAG  += --timestamp 1491794758
