...
void encryptAES(unsigned char plaintext[17], unsigned char key[17], unsigned char cipherText[17])
{
    ...
    // Copy the final state into the ciphertext with column-major ordering
...
const unsigned long Rcon[]={0x01000000,0x02000000,0x04000000,0x08000000,0x10000000,0x20000000,
