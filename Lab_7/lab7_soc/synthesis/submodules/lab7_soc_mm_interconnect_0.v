...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [105:0] switch_in_s1_agent_rf_source_data;                                                  // SWITCH_IN_s1_agent:rf_source_data -> SWITCH_IN_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] switch_in_s1_agent_rsp_fifo_out_data;                                               // SWITCH_IN_s1_agent_rsp_fifo:out_data -> SWITCH_IN_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> SWITCH_IN_s1_agent:cp_valid
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> SWITCH_IN_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // SWITCH_IN_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> SWITCH_IN_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> SWITCH_IN_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> SWITCH_IN_s1_agent:cp_endofpacket
	...
	wire  [105:0] button_in_s1_agent_rf_source_data;                                                  // BUTTON_IN_s1_agent:rf_source_data -> BUTTON_IN_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] button_in_s1_agent_rsp_fifo_out_data;                                               // BUTTON_IN_s1_agent_rsp_fifo:out_data -> BUTTON_IN_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> BUTTON_IN_s1_agent:cp_valid
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> BUTTON_IN_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // BUTTON_IN_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> BUTTON_IN_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> BUTTON_IN_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> BUTTON_IN_s1_agent:cp_endofpacket
	...
	wire          switch_in_s1_agent_rp_valid;                                                        // SWITCH_IN_s1_agent:rp_valid -> router_008:sink_valid
	wire  [104:0] switch_in_s1_agent_rp_data;                                                         // SWITCH_IN_s1_agent:rp_data -> router_008:sink_data
	wire          switch_in_s1_agent_rp_ready;                                                        // router_008:sink_ready -> SWITCH_IN_s1_agent:rp_ready
	wire          switch_in_s1_agent_rp_startofpacket;                                                // SWITCH_IN_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          switch_in_s1_agent_rp_endofpacket;                                                  // SWITCH_IN_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          button_in_s1_agent_rp_valid;                                                        // BUTTON_IN_s1_agent:rp_valid -> router_009:sink_valid
	wire  [104:0] button_in_s1_agent_rp_data;                                                         // BUTTON_IN_s1_agent:rp_data -> router_009:sink_data
	wire          button_in_s1_agent_rp_ready;                                                        // router_009:sink_ready -> BUTTON_IN_s1_agent:rp_ready
	wire          button_in_s1_agent_rp_startofpacket;                                                // BUTTON_IN_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          button_in_s1_agent_rp_endofpacket;                                                  // BUTTON_IN_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          switch_in_s1_agent_rdata_fifo_src_valid;                                            // SWITCH_IN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] switch_in_s1_agent_rdata_fifo_src_data;                                             // SWITCH_IN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          switch_in_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_006:in_0_ready -> SWITCH_IN_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> SWITCH_IN_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> SWITCH_IN_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // SWITCH_IN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> SWITCH_IN_s1_agent:rdata_fifo_sink_error
	wire          button_in_s1_agent_rdata_fifo_src_valid;                                            // BUTTON_IN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] button_in_s1_agent_rdata_fifo_src_data;                                             // BUTTON_IN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          button_in_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_007:in_0_ready -> BUTTON_IN_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> BUTTON_IN_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> BUTTON_IN_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // BUTTON_IN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> BUTTON_IN_s1_agent:rdata_fifo_sink_error
